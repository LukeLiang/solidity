...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface AuctionProxyAdminInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'upgradeAndCall', data: BytesLike): Result;
  ...
  export interface AuctionProxyAdmin extends BaseContract {
    
    connect(runner?: ContractRunner | null): AuctionProxyAdmin;
    waitForDeployment(): Promise<this>;

    interface: AuctionProxyAdminInterface;
