...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../../common.js"
  ...
  export interface AuctionTransparentProxyInterface extends Interface {
  ...
  export interface AuctionTransparentProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): AuctionTransparentProxy;
    waitForDeployment(): Promise<this>;

    interface: AuctionTransparentProxyInterface;
